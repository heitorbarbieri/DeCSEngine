 ...
 * date: 20150203
 */
public class DeCSStandardAnalyzerTest {
    private static final String DECS_XML = "resources/decs/xml/decs-metadata.xml";
    
    private final Map<String,DecsSyn> decs;
    private final DeCSStandardAnalyzer analyzer;
    
    public DeCSStandardAnalyzerTest() throws IOException, 
                                             ParserConfigurationException, 
                                                                  SAXException {
        decs = new IndexDecs().indexTerms(DECS_XML);
        analyzer = new DeCSStandardAnalyzer(decs);
    }
    ...
    public void testAnalyzer() throws IOException {
        ...
        final String[] arr14 = { "tais", "como:", "abdome", "abdominais", 
            "abdominal", "abdominal neoplasms", "abdominales", "c04.588.033", 
            "do", "neoplasias", "neoplasias abdominais", "neoplasias abdominales",
        ...
        final String[] arr17 = { "d02.705.539.900", "d02.886.309.900", "temefos", 
            ...
            "como", "abdome", "abdominais", "abdominal","abdominal neoplasms", 
            "abdominales", "c04.588.033", "do", "neoplasias", 
            "neoplasias abdominais", "neoplasias abdominales", "neoplasms", 
            "tumores", "tumores abdominais", "tumores abdominales", 
        ...
        final String in21 = "Temefós proteja os abatedouros de doenças como "
               ...
               + "***[^d22062]! ^d1111111";
        final String[] arr21 = { "temefos", "proteja", "os", "abatedouros", 
            "abattoirs", "j01.576.423.200.700.100", "mataderos", "matadouros", 
            "slaughterhouses", "de", "doencas", "como", "<^d8>",                        
            "abdome", "abdominais", "abdominal","abdominal neoplasms", 
            "abdominales", "c04.588.033", "do", "neoplasias", 
            "neoplasias abdominais", "neoplasias abdominales", "neoplasms", 
            "tumores", "tumores abdominais", "tumores abdominales", 
            "tumores do abdome","q50.040.020q05.010", "dentre", "<^d8><^d22062>", 
        ...
        final String in23 = " Temefós/sangre   ";
        final String[] arr23 = { "d02.705.539.900", "d02.886.309.900", "temefos", 
                                 "/blood", "/sangre", "/sangue",
                            "blood", "q50.040.020q05.010", "sangre", "sangue" };
        final List<String> expResult23 = Arrays.asList(arr23);
        final List<String> result23 = AnalyzerUtils.getTokenList(analyzer, in23);
